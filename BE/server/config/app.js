...
mongoose_1.default.connect((DBConfig.RemoteURI) ? DBConfig.RemoteURI : DBConfig.LocalURI || "mongodb://127.0.0.1/media");
...
let strategy = new JWTStrategy(jwtOptions, function (jwt_payload, done) {
    user_1.default.findOne({ id: jwt_payload.id }, (err, user) => {
        if (err) {
